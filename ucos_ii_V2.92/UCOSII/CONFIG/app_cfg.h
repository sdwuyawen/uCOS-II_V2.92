...
#define APP_CFG_TASK_PRESS_PRIO					 10u
#define APP_CFG_TASK_FLOW_PRIO					 12u
#define APP_CFG_TASK_BLUETOOTH_PRIO			     13u
#define APP_CFG_TASK_NET_PRIO					 14u
#define APP_CFG_TASK_MODBUS_PRIO			     15u
#define APP_CFG_TASK_PCF2129_PRIO				 16u
#define APP_CFG_TASK_KEY_PRIO					 18u
#define APP_CFG_TASK_ADC_PRIO					 20u
#define APP_CFG_TASK_LCD_PRIO					 22u
#define APP_CFG_TASK_SDRecord_PRIO			     24u
#define APP_CFG_TASK_Humidifier_PRIO			 26u
#define APP_CFG_TASK_SDWrite_PRIO			     28u

#define  APP_CFG_TASK_START_PRIO                 60u
...
//#define  APP_CFG_TASK_NET_STK_SIZE                       1024u
//#define  APP_CFG_TASK_FSMC_STK_SIZE                      1024u
//#define  APP_CFG_TASK_FLOW_STK_SIZE                      1024u
